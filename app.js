...
var merchant_id = "AAAAAAA";
var merchant_key = "XXXXXXXX";
var merchant_salt = "YYYYYYY";

// Sepet - Fiyatlar TL cinsinden (string, nokta ayraçlı)
...
var user_ip = "185.213.169.239";
var email = "testnon3d@paytr.com"; // Müşterinizin sitenizde kayıtlı veya form vasıtasıyla aldığınız eposta adresi.

// Payment amount - Token için double format (string), form için integer
var payment_amount = "161.92"; // Token oluştururken bu değer kullanılacak (TL cinsinden)
var payment_amount_cents = "161.92"; // Form'da gönderilecek (kuruş cinsinden, integer)
var currency = "TL";
var test_mode = "1";
...
// Taksit kontrolü
var no_installment = installment_count === "0" ? "1" : "0";
...
app.get("/", function (req, res) {
  ...
  console.log(
    "payment_amount_cents (for form): " +
      payment_amount_cents +
      " (type: " +
      typeof payment_amount_cents +
      ")"
  );
  ...
  context = {
    ...
    email,
    payment_type,
    payment_amount_cents, // Form'da integer olarak gönderilecek
    currency,
    test_mode,
    non_3d,
    merchant_ok_url,
...
app.post("/callback", function (req, res) {
  ...
  if (callback.status == "success") {
    // basarili
    console.log("----!!!![PayTR] Ödeme Başarılı: " + callback.merchant_oid);
  } else {
    /// basarisiz
